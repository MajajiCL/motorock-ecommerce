...
export default function ProductCard({ product, onOpenDetail, onAddToCart }) {
  ...
  return (
    <div className="bg-white rounded-[24px] border border-[#e4e4e7] overflow-hidden flex flex-col justify-between hover:shadow-motorock hover:border-[#e60000]/40 transition-all duration-200 group">
      {/* Contenedor Imagen */}
      <div
      ...
      >
        ...
        <div className="absolute top-3 left-3 flex flex-col gap-1 z-10">
          ...
          {hasOptions && (
            <span className="bg-white text-[#121214] border border-[#e4e4e7] text-[9px] font-semibold px-2 py-0.5 rounded-full shadow-sm">
              Tallas
            </span>
          )}
        </div>
      ...
      <div className="p-5 flex-1 flex flex-col justify-between bg-white">
        <div>
          ...
          <div className="flex items-center justify-between gap-2 mb-1.5">
            <span className="text-[10px] text-[#e60000] font-bold uppercase tracking-wider truncate">
        ...
        <div className="mt-4 pt-3 border-t border-zinc-100 space-y-3">
          <div>
            <div className="flex items-baseline gap-2">
              <span className="text-base sm:text-lg font-extrabold text-[#121214]">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => onOpenDetail(product)}
              className="flex-1 py-2 px-3 rounded-full bg-[#f8f9fa] hover:bg-zinc-200 text-[#121214] font-semibold text-xs transition-colors flex items-center justify-center gap-1.5 cursor-pointer border border-[#e4e4e7]"
            >
              <Eye size={13} />
            ...
            <button
              ...
              className={`p-2.5 rounded-full font-bold transition-all ${
                isOutOfStock
                  ...
                  : "bg-[#e60000] hover:bg-[#cc0000] text-white shadow-motorock-red cursor-pointer"
              }`}
