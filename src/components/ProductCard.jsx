      ...
      <div className="p-5 flex-1 flex flex-col justify-between bg-white">
        ...
        <div className="mt-4 pt-3 border-t border-slate-100 space-y-3">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => onOpenDetail(product)}
              className="flex-1 py-2 px-3 rounded-full bg-[#f6f6fa] hover:bg-[#e5e5eb] text-[#151581] font-semibold text-xs transition-colors flex items-center justify-center gap-1.5 cursor-pointer border border-[#e5e5eb]"
            >
              <Eye size={13} />
