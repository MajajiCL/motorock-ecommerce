    ...
    <section className="my-14">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-2 mb-6">
        <div>
          ...
          <h2 className="text-2xl sm:text-3xl font-normal text-[#151581] mt-1 tracking-tight">
            Catálogo de Alto Rendimiento
          </h2>
        </div>
        <p className="text-xs text-[#a1a1cd] max-w-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <CardSpotlight
          ...
          className="md:col-span-2 lg:col-span-2 p-6 flex flex-col justify-between cursor-pointer relative overflow-hidden group min-h-[240px] bg-white rounded-[28px] border border-[#e5e5eb]"
        >
          <BorderBeam size={180} duration={8} colorFrom="#151581" colorTo="#5465ff" />
          <div className="relative z-10 max-w-sm space-y-2">
            <div className="flex items-center gap-2">
              <span className="p-2 rounded-xl bg-indigo-50 text-[#151581]">
                <Shield size={18} />
              </span>
              <span className="text-xs font-semibold text-[#a1a1cd] uppercase tracking-wide">247 Modelos Homologados</span>
            </div>
            <h3 className="text-xl font-bold text-[#151581] group-hover:text-[#5465ff] transition-colors">
          ...
          <div className="relative z-10 pt-4 flex items-center justify-between">
            <span className="text-xs font-bold text-[#151581] flex items-center gap-1 group-hover:translate-x-1 transition-transform">
              <span>Ver Cascos</span>
              <ArrowRight size={14} />
            </span>
            <span className="text-[11px] font-semibold text-[#00bb76]">Desde $32.900 CLP</span>
          </div>
        ...
        <CardSpotlight
          ...
          className="p-6 flex flex-col justify-between cursor-pointer relative overflow-hidden group min-h-[240px] bg-white rounded-[28px] border border-[#e5e5eb]"
        >
          <div className="relative z-10 space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-semibold text-[#a1a1cd] uppercase tracking-wide">322 Repuestos</span>
            </div>
            <h3 className="text-lg font-bold text-[#151581] group-hover:text-[#5465ff] transition-colors">
              Transmisiones D.I.D
            </h3>
            <p className="text-xs text-[#292824]/80">
        ...
        >
          <div className="relative z-10 space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-semibold text-[#a1a1cd] uppercase tracking-wide">73 Variedades</span>
            </div>
            <h3 className="text-lg font-bold text-[#151581] group-hover:text-[#5465ff] transition-colors">
              Aceites Motul 4T
            </h3>
        ...
        <div className="md:col-span-2 lg:col-span-2 p-6 bg-[#151581] text-white rounded-[28px] flex flex-col justify-between shadow-sm relative overflow-hidden min-h-[240px]">
          <div className="relative z-10 max-w-sm space-y-2">
            <div className="flex items-center gap-2">
          ...
          <div className="relative z-10 pt-4 flex flex-wrap items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="bg-white hover:bg-slate-100 text-[#151581] px-5 py-2.5 rounded-full font-bold text-xs shadow-sm flex items-center gap-1.5 transition-colors cursor-pointer"
            >
              <span>Agendar por WhatsApp</span>
              <ArrowRight size={14} />
            </a>
            <span className="text-xs text-slate-300">+56 9 7696 7438</span>
          </div>
        </div>
        ...
        <CardSpotlight
          ...
          className="md:col-span-1 lg:col-span-2 p-6 flex flex-col justify-between cursor-pointer relative overflow-hidden group min-h-[240px] bg-white rounded-[28px] border border-[#e5e5eb]"
        >
          <div className="relative z-10 space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-semibold text-[#a1a1cd] uppercase tracking-wide">Indumentaria Biker</span>
            </div>
            <h3 className="text-lg font-bold text-[#151581] group-hover:text-[#5465ff] transition-colors">
