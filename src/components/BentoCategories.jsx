    ...
    <section className="my-14">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <CardSpotlight
          ...
          className="md:col-span-2 lg:col-span-2 p-6 flex flex-col justify-between cursor-pointer relative overflow-hidden group min-h-[240px] bg-white rounded-[28px] border border-[#e4e4e7]"
        >
          <BorderBeam size={180} duration={8} colorFrom="#e60000" colorTo="#ff4d4d" />
          <div className="relative z-10 max-w-sm space-y-2">
            <div className="flex items-center gap-2">
              <span className="p-2 rounded-xl bg-red-50 text-[#e60000]">
                <Shield size={18} />
              </span>
              <span className="text-xs font-bold text-[#e60000] uppercase tracking-wide">247 Modelos Homologados</span>
            </div>
        ...
        <CardSpotlight
          ...
          className="p-6 flex flex-col justify-between cursor-pointer relative overflow-hidden group min-h-[240px] bg-white rounded-[28px] border border-[#e4e4e7]"
        >
          <div className="relative z-10 space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-zinc-500 uppercase tracking-wide">322 Repuestos</span>
            </div>
        ...
        >
          <div className="relative z-10 space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-zinc-500 uppercase tracking-wide">73 Variedades</span>
            </div>
            <h3 className="text-lg font-bold text-[#121214] group-hover:text-[#e60000] transition-colors">
              Aceites Motul 4T
            </h3>
        ...
        <div className="md:col-span-2 lg:col-span-2 p-6 bg-[#121214] text-white rounded-[28px] flex flex-col justify-between shadow-sm relative overflow-hidden min-h-[240px] border border-zinc-800">
          <div className="relative z-10 max-w-sm space-y-2">
            <div className="flex items-center gap-2">
              <span className="p-2 rounded-xl bg-red-950/60 text-[#e60000]">
                <Wrench size={18} />
              </span>
              <span className="text-xs font-bold text-[#e60000] uppercase tracking-wide">Servicio Técnico Talca</span>
            </div>
          ...
          <div className="relative z-10 pt-4 flex flex-wrap items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="bg-[#e60000] hover:bg-[#cc0000] text-white px-5 py-2.5 rounded-full font-bold text-xs shadow-motorock-red flex items-center gap-1.5 transition-colors cursor-pointer"
            >
              <span>Agendar por WhatsApp</span>
              <ArrowRight size={14} />
            </a>
            <span className="text-xs text-zinc-300">+56 9 7696 7438</span>
          </div>
        </div>
        ...
        <CardSpotlight
          ...
          className="md:col-span-1 lg:col-span-2 p-6 flex flex-col justify-between cursor-pointer relative overflow-hidden group min-h-[240px] bg-white rounded-[28px] border border-[#e4e4e7]"
        >
          <div className="relative z-10 space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-zinc-500 uppercase tracking-wide">Indumentaria Biker</span>
            </div>
            <h3 className="text-lg font-bold text-[#121214] group-hover:text-[#e60000] transition-colors">
