      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-2.5">
            <h4 className="text-xs font-bold text-[#151581] uppercase tracking-wider">Categorías</h4>
            <ul className="space-y-1.5 text-xs text-slate-600">
              ...
              <li><a href="#" className="hover:text-[#5465ff] transition-colors">Chaquetas y Guantes LS2</a></li>
          ...
          {/* Col 3 */}
          <div className="space-y-2.5">
            <h4 className="text-xs font-bold text-[#151581] uppercase tracking-wider">Ecosistema Móvil</h4>
            <ul className="space-y-2 text-xs text-slate-600">
              <li>
                <button
                  onClick={onOpenAppModal}
                  className="flex items-center gap-1.5 text-[#151581] font-semibold hover:underline cursor-pointer"
                >
          ...
          {/* Col 4 */}
          <div className="space-y-2.5">
            <h4 className="text-xs font-bold text-[#151581] uppercase tracking-wider">Locales y Contacto</h4>
            <div className="space-y-1.5 text-xs text-slate-600">
              <p className="flex items-start gap-1.5">
                <MapPin size={13} className="text-[#151581] flex-shrink-0 mt-0.5" />
              ...
              <p className="flex items-center gap-1.5">
                <Mail size={13} className="text-[#a1a1cd] flex-shrink-0" />
