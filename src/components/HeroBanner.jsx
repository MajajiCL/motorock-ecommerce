    ...
    <ImageStreamHero images={STREAM_PRODUCTS} cards={8} speed={22} axis={52}>
      <div className="pt-8 pb-16 flex flex-col items-center text-center">
        ...
        <div className="inline-flex items-center gap-2 glass-pill px-4 py-1.5 rounded-full mb-6 animate-in fade-in duration-300">
          ...
          <AnimatedShinyText className="text-xs text-[#0f172a]">
            ⚡ MotoRock App 2026 • Despacho Express en 24h & Retiro en 2h en Talca
          </AnimatedShinyText>
        </div>

        {/* 2. Display Headline with Outfit Typography */}
        <h1 className="text-4xl sm:text-5xl lg:text-[56px] font-black text-[#0f172a] leading-[0.98] tracking-tight max-w-3xl mx-auto font-heading">
        ...
        {/* 3. Subtext */}
        <p className="text-base sm:text-lg text-slate-600 max-w-xl mx-auto mt-6 leading-relaxed font-normal">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3.5 mt-8">
          <button
            ...
            className="flex items-center gap-2.5 bg-[#0f172a] hover:bg-black text-white px-6 py-3.5 rounded-full text-xs font-bold shadow-md hover:shadow-lg transition-all cursor-pointer"
          >
            <span className="text-base"></span>
            <div className="text-left">
              <span className="block text-[8px] uppercase tracking-wider text-slate-400 leading-none">Disponible en</span>
          ...
          >
            <span className="text-base">🤖</span>
            <div className="text-left">
              <span className="block text-[8px] uppercase tracking-wider text-slate-400 leading-none">Descargar en</span>
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[#e60000] hover:bg-[#cc0000] text-white px-6 py-3.5 rounded-full text-xs font-bold shadow-racing transition-all cursor-pointer"
          >
        ...
        {/* 5. Centerpiece: iPhone 16 Pro Mockup with Floating Glass Badges */}
        <div className="mt-14 w-full max-w-5xl relative flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-8 px-4">
          ...
          >
            ...
            <div className="min-w-0">
              <span className="text-[9px] font-extrabold text-[#00bb76] uppercase tracking-wider flex items-center gap-1">
          ...
          >
            ...
            />
            <div className="min-w-0">
              <span className="text-[9px] font-extrabold text-[#00bb76] uppercase tracking-wider block">
                100% Sintético Ester
              </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto w-full mt-14 text-left">
          <div className="glass-panel p-5 rounded-[24px] space-y-1">
            <span className="text-[11px] font-extrabold text-[#00bb76] uppercase tracking-wider flex items-center gap-1 font-heading">
              <CheckCircle2 size={13} />
              <NumberTicker value={24} suffix=" a 48 Horas" />
            </span>
            <h4 className="text-sm font-bold text-[#0f172a] font-heading">Despacho Express a Todo Chile</h4>
            <p className="text-xs text-slate-500">Envíos asegurados por Starken y Chilexpress directo a tu puerta.</p>
          </div>

          <div className="glass-panel p-5 rounded-[24px] space-y-1">
            <span className="text-[11px] font-extrabold text-[#e60000] uppercase tracking-wider flex items-center gap-1 font-heading">
              <CheckCircle2 size={13} className="text-[#e60000]" />
              <NumberTicker value={726} prefix="+" suffix=" Repuestos" />
            </span>
            <h4 className="text-sm font-bold text-[#0f172a] font-heading">Garage y Compatibilidad Exacta</h4>
            <p className="text-xs text-slate-500">Filtra por modelo y recibe la cadena, piñón y aceite correcto.</p>
          </div>

          <div className="glass-panel p-5 rounded-[24px] space-y-1">
            <span className="text-[11px] font-extrabold text-[#0f172a] uppercase tracking-wider flex items-center gap-1 font-heading">
              <Clock size={13} className="text-[#e60000]" />
              <NumberTicker value={2} prefix="Listo en " suffix=" Horas" />
            </span>
            <h4 className="text-sm font-bold text-[#0f172a] font-heading">Retiro en Tienda Talca</h4>
            <p className="text-xs text-slate-500">Compra en la app y retira listo en Av. 2 Sur 771 y 777.</p>
          </div>
        </div>
      </div>
    </ImageStreamHero>
